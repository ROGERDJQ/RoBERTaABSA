...
class Instructor:
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_data_loader):
                ...
                if global_step % self.opt.log_step == 0:
                    ...
                    fitlog.add_metric(f1, name="f1", step=global_step)
    ...
    def run(self, repeats=5):
        ...
        for i in range(1):
            ...
            fitlog.finish()
        print(accs)
        print("max_test_acc_avg:{:.4f}/{:.4f}".format(np.mean(accs), np.std(accs)))
        print(f1s)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", default="laptop", type=str, help="restaurant, laptop"
    )
    ...
    fitlog.add_hyper(value="PWCN", name="model")
